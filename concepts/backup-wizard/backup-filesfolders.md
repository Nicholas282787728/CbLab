This tutorial illustrates how to use the Backup Wizard for backing up your files with a Windows version of CloudBerry Backup. This wizard enables you to save and re-use the configured backup plans.

...
* [Restore Wizard Overview](chapter1.md)
  ...
  * [Step 3 - Choose Data to Restore](chapter1/step-3-choose-data-to-restore.md)
    ...
    * [3.5 - Restore System State Data](chapter1/step-3-choose-data-to-restore/35-restore-system-state-data.md)
      * [3.5.1 - Select File Versions to Restore](chapter1/step-3-choose-data-to-restore/35-restore-system-state-data/361-select-the-backup-type.md)
      * [3.5.2 - Specify the Restore Source](chapter1/step-3-choose-data-to-restore/35-restore-system-state-data/362-select-an-intermediate-storage.md)
      * [3.5.3 - Specify the Restore Desination](chapter1/step-3-choose-data-to-restore/35-restore-system-state-data/363-check-network-shares.md)
